...
export default function HomePage() {
  ...
  // placeholder discount count until Supabase integration
  const [discountCount] = useState(12);
  ...
  // In production: replace with Supabase fetch or real-time subscription.
  // Placeholder value is already applied as the initial state above.
